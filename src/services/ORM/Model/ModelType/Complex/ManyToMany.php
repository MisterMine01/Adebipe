...
class ManyToMany extends AbstractType
{
    ...
    public function __construct($me_object, $object_type, bool $is_first, bool $not_null = false)
    {
        $this->me_object = $me_object;
        $this->object_type = $object_type;
        $this->named_me = strtolower(substr(get_class($me_object), strrpos(get_class($me_object), '\\') + 1));
